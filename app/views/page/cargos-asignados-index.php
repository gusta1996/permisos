...
<a href="./cargos-asignados.php?page=registro" class="flex items-center w-max gap-2 rounded-md shadow-sm bg-indigo-500 px-3 py-2 mb-4 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2" />
    </svg>Ver registro completo
</a>
...
<div class="flex items-center gap-2 bg-emerald-200 rounded-md shadow-sm mb-6 p-4 text-emerald-600">
    ...
    <p>Los cargos y áreas ya deben estar agregados en <a href="./estructura.php" class="text-indigo-600 font-semibold">estructura</a>.</p>
</div>
    ...
    <div class="px-4 py-6">
        ...
        <form id="ver-guardar-contratoEstructura" action="javascript:void(0);" onsubmit="appFuncionarioEstructura.actualizarContratoEstructura()" class="hidden bg-slate-100 p-4 mt-6 rounded-md border">
            <div class="mb-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <!-- Funcionario -->
                <div id="ver-funcionario" class="hidden sm:col-span-6"></div>

                <!-- Contrato -->
                <div id="ver-guardar-contrato" class="sm:col-span-6"></div>
...
<!-- Contratos y cargos -->
<div id="contrato-cargo" class="bg-white rounded-md shadow-sm mb-6">
    <div class="border-b border-gray-900/10 p-4">
        <div class="flex items-center justify-between gap-6 mb-5">
            <!-- Titulo -->
            <h2 class="flex-auto text-lg font-semibold leading-7 text-gray-900">Contratos y cargos</h2>
            <!-- Buscar por Tipo -->
