...
<div id="filtros-reporte" class="bg-white rounded-md shadow-sm mb-6">
    <div class="p-4">
        <form action="javascript:void(0);" onsubmit="appReporte.reporteMensualPDF()" class="flex items-center gap-4">
            ...
            <button type="submit" class="flex items-center h-[38px] w-max gap-2 rounded-md bg-indigo-500 px-4 py-2 mt-auto text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
