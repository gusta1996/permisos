...
?>
        ...
        <div class="bg-white rounded-md shadow-sm mb-6">
            ...
            <div class="border-b border-gray-900/10 p-4">
                <h2 class="text-lg font-semibold leading-7 text-gray-900">Agregar contrato</h2>
            </div>

            <!-- Formulario Contrato -->
            <div class="p-4">
                <form action="javascript:void(0);" onsubmit="appContrato.guardarContrato()">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-7">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" required id="detalle-contrato" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="text" required id="tipo-contrato" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6">
                            </div>
                        </div>
            ...
            <!-- Mensaje de error -->
            <div id="error-contrato" class="hidden p-4">
            </div>
        </div>
        ...
        <div class="bg-white rounded-md shadow-sm mb-6">
            <!-- Titulo -->
            <div class="border-b border-gray-900/10 p-4">
                <h2 class="text-lg font-semibold leading-7 text-gray-900 mb-2">Buscar contrato</h2>
                <form action="javascript:void(0);" oninput="appContrato.busquedaContrato()">
                    <div class="relative mb-1">
                        ...
                        <input type="search" id="busqueda-contrato" placeholder="Búsqueda..." class="block w-full rounded-md border-0 py-3 pl-10 pr-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm">
                    </div>
                </form>
            </div>
        ...
        <script src="../assets/scriptContrato.js"></script>
