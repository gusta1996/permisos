...
?>
        ...
        <div class="bg-white rounded-md shadow-sm mb-6">
            ...
            <div class="border-b border-gray-900/10 p-4">
                <h2 class="text-lg font-semibold leading-7 text-gray-900">Agregar cargo</h2>
            </div>
                ...
                <form action="javascript:void(0);" onsubmit="app.guardarCargo()">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-7">
                        ...
                        <div class="sm:col-span-3">
                            <label class="block text-sm font-medium leading-6 text-gray-900">Nuevo cargo:</label>
                            <div class="mt-2">
                                <input type="text" required id="detalle-cargo" class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6">
                            </div>
                        </div>

                        <!-- Sección -->
                        <div class="sm:col-span-3">
                            <label class="block text-sm font-medium leading-6 text-gray-900">Sección al que pertenece:</label>
                            <div class="mt-2">
                                <select id="seccion-cargo" required class="selectBuscador h-[38px] block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6">
            ...
            <!-- Mensaje de error -->
            <div id="error-cargo" class="hidden p-4">
            </div>
        </div>
            ...
            <div class="border-b border-gray-900/10 p-4">
                ...
                <form action="javascript:void(0);" oninput="app.busquedaCargo()">
                    <div class="relative mb-1">
                        ...
                        <input type="search" id="busqueda-cargo" placeholder="Búsqueda..." class="block w-full rounded-md border-0 py-3 pl-10 pr-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm">
                    </div>
                </form>
            </div>
        ...
        <script src="../assets/scriptCargo.js"></script>
