        ...
        fetch("../controllers/guardarSeccion.php", { method: "POST", body: formSeccion })
            ...
            .then((data) => {
                if (data == true) {
                    ...
                    window.location.href = '../views/seccion.php';
                } else {
                ...
                if (item != '') {
                    for (let i = 0; i < item.length; i++) {
                        ...
                        <tr class="h-16 border-b last:border-b-0 border-b-white-100">
                            ...
                            <td class="capitalize text-slate-700 pr-4">${item[i].seccion_detalle}</td>
                            ...
                            <td class="flex justify-end flex-row items-center gap-4 h-16 w-fit ml-auto">
                                ...
                                <button onclick="app.eliminarSeccion(${item[i].id_seccion})" title="Anular" class="${item[i].seccion_estado === 'anulado' ? 'hidden ' : ''}btn-eliminar flex items-center gap-2 min-h-fit rounded-md bg-red-50 px-3 py-2 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                                ...
                                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <select id="editar-departamento-seccion" required class="departamento-id-${data.id_departamento_fk} h-[38px] capitalize block w-full mt-2 rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 sm:text-sm sm:leading-6">
