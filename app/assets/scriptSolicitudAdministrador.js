const appSolicitud = new (function () {
                    ...
                    html += `
                        <tr class="h-14 border-b last:border-b-0 border-b-white-100">
                            ...
                            <td class="flex justify-end flex-row items-center gap-4 h-14 w-fit ml-auto">
                                <button onclick="appSolicitud.editarSolicitud(${item[i].id_funcionario_solicitud})" class="btn-editar flex items-center gap-2 min-h-fit rounded-md bg-blue-50 px-3 py-2 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">
    ...
    this.guardarSolicitud = () => {
        ...
        formSolicitud.append('id_funcionario_estructura', this.funcionarioSolicitud.value);
